...
function RegistrationForm() {
  ...
  return (
    <div style={styles.formContainer}>
         <Description>
        <p>
          useReducer — это хук в React, который используется
          для управления сложным состоянием , особенно если
          оно имеет много подзначений или если следующее состояние
          зависит от предыдущего .
        </p>
        <p>
         Каждый тип действия говорит редьюсеру, что делать с состоянием :
        Изменить поле Проверить полеЗапустить отправку Обработать успех или ошибку Сбросить форму
        </p>
      </Description>
